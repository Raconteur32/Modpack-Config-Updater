...
public class SbcouVersionsDataBase {
    ...
    private static SbcouVersionsDataBase latestInstance;

    /**
     * Create a database object and initialize it
     */
    public SbcouVersionsDataBase() throws SQLException {
        connect();
        init();
        latestInstance = this;
    }
    ...
    private void init() throws SQLException {
        ...
        DbDataModification.init(getConnection());
        DbDataPatch.init(getConnection());
    }
     ...
     */
    public static SbcouVersionsDataBase getLatestInstance() {
